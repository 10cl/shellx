...
public final class PtyProcess extends Process {
    private static String TAG = "PtyProcess";
    ...
    public  static void loadLibrary() {
        LOGGER.d("loaded library path: " + libraryPath);
    ...
    public static native PtyProcess execve(final String filename, final String[] args,
                                           final String[] env);


    public static PtyProcess execve(final String filename, final String[] args,
                                    final Map<String, String> env) {
        LOGGER.d("execve, filename: " + filename + ", args: " + args + ", env: " + env);
        if (env == null) {
    ...
    public static PtyProcess execv(final String filename, final String[] args) {
        return execve(filename, args, (String[]) null);
    }


    public static PtyProcess execl(final String filename,
                                   final Map<String, String> env, final String... args) {
        return execve(filename, args, env);
    }


    public static PtyProcess execl(final String filename, final String... args) {
        return execv(filename, args);
    }


    public static PtyProcess system(final String command,
                                    final Map<String, String> env) {
    ...
    public static void getSize(final OutputStream s, int[] result) throws IOException {
    ...
    public static native void getSize(int fd, int[] result) throws IOException;
    ...
    private static final class Utils21 {
        ...
        private static void close(final FileDescriptor fd) throws IOException {
            try {
                Os.close(fd);
