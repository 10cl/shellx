...
// TODO: Perhaps add overload to FromBytes to take a sign and magnitude
  ...
  public final class EInteger implements Comparable<EInteger> {
     ...
     * {@link EDecimal "Forms of numbers"}) of the
...
@Deprecated
     ...
     * two's-complement form (see {@link EDecimal "Forms of
...
@Deprecated
     ...
     * {@link EDecimal "Forms of numbers"}).).
     * @return The bit position of the lowest bit set in the number's absolute
     ...
     * EDecimal "Forms of numbers"}) of this object's
     * value.
...
@Deprecated
     ...
     * {@link EDecimal "Forms of numbers"}) for the
     ...
     * number's two's-complement form (see {@link EDecimal
